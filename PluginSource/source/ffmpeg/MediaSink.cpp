...
zrtsp2::MediaSink::MediaSink(int height, int width, AVPixelFormat format)
{
	m_Height = height;
	m_Width = width;
	m_dstFormat = format;
...
int zrtsp2::MediaSink::setSrcCodecContext(AVCodecContext * p_src_codec_context)
{
